      ...
      <div className={classes.root}>
          ...
          <div className={classes.header}>
            <Typography variant="h2" component={"span"}>
              <Box fontFamily="Roboto" fontWeight={100} lineHeight={2}>
                6 newly graduated economists to one of the worlds biggest
                fintech company
              </Box>
            </Typography>
        ...
        <div className={classes.flex}>
          <div className={classes.div1}>
            <div >
              <Typography variant={"h5"} component={"span"} className={classes.paragraph}>
                
                  As a stakeholder mapping representative you will be laying the
                  foundation for our clients most important deals and
                  partnerships. This is a crucially important role to our
                  clients company and you will therefore work closely with, and
                  present your findings to the senior commercial teams. Do you
                  want to get your foot in the door at a global fintech company?
            ...
            <div>
              <Typography component={"span"}>
                <Box fontFamily="Verdana" lineHeight={1.8}>
                  ...
                  assignment. You will have to do a logical test for this
                  process, to try your skills you can do this:{" "}
                  <Link>https://www.123test.com/logical-reasoning-test/</Link>{" "}
                  We want you who get 9 and 10 to apply for this position.
                </Box>
              </Typography>
            </div>
            ...
            <div>
              <Typography component={"span"}>
                <Box fontFamily="Verdana" lineHeight={1.8}>
                  ...
                  will help our commercial organization enter negotiations
                  quickly and win over our target companies.
                </Box>
              </Typography>
            </div>
            ...
            <div className={classes.list}>
              <ul>
                ...
                <li>
                  Passionate about your job and enjoys a fast paced,
                  international working environment
                </li>
                <li>
                  Proactive by nature and comes up with new thinking and
                  ideation that adds value and innovation to your team
                </li>
                <li>
          ...
          <div className={classes.div2}>
            ...
            <div className={classes.snabbfakta}>
              <div className={classes.snabbHeader}>
                <Typography component={"span"} style={{color:'#f0f0ed', textShadow: '0 0 3px #000000, 0 0 5px #000000'}}>
            ...
            <div className={classes.aboutJob}>
              ...
              <Typography component={"span"}>
                <Box fontWeight={500} m={1} fontSize={15}>
                  ...
                  svarar dig gärna på mail@insamail.se. Ange annons-ID i
                  ditt mail: 5000000
                </Box>
              </Typography>
            </div>
